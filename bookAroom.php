        ...
        <div class="col-lg-9">
          <div class="tabs-wrapper clr">
            <div class="row">
              ...
              $query = "SELECT * FROM `room` r ,`accomodation` a WHERE r.`accomodation_id`=a.`accomodation_id` AND `accomodation_name`='" . $_POST['accomodation'] . "' AND `num_person` = " . $_POST['person'];
              $mydb->setQuery($query);
