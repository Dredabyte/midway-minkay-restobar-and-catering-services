              ...
              <div class="form-group  ">
                <div class="col-md-10">
                  ...
                  <div class="col-md-8 input-group">
                    <input type="text" data-date="" data-date-format="yyyy-mm-dd" data-link-field="any" data-link-format="yyyy-mm-dd" name="dbirth" id="dbirth" value="<?php echo  date($res->birthdate); ?>" readonly="true" class="dbirth form-control  input-sm">
