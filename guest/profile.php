                ...
                <div class="form-group">
                     ...
                     <div class="form-group">
                      <div class="col-md-10">
                        ...
                        <div class="col-md-8">
                          <input name="city" type="text" value="<?php echo $res->city; ?>" class="form-control input-sm" id="city" />
                        </div>
                      </div>
                    </div>
                     <div class="form-group">
                      ...
                      <div class="col-md-10">
                        ...
                        <div class="col-md-8 input-group">
                           <input type="text" data-date="" data-date-format="yyyy-mm-dd" data-link-field="any" 
                                 ...
                                 value="<?php echo  date($res->birthdate); ?>" 
                     ...
                     <div class="form-group">
                      <div class="col-md-10">
                        ...
                        <div class="col-md-8">
                          <input name="phone" type="text" value="<?php echo $res->phone; ?>" class="form-control input-sm" id="phone" />
                        </div>
                      </div>
                     </div>
                     ...
                     <div class="form-group">
                      <div class="col-md-10">
                        ...
                        <div class="col-md-8">
                          <input name="nationality" type="text" value="<?php echo $res->nationality; ?>" class="form-control input-sm" id="nationality" />
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-10">
                        ...
                        <div class="col-md-8">
                          <input name="company" type="text" value="<?php echo $res->company; ?>" class="form-control input-sm" id="company" />
                        </div>
                      </div>
                    </div>
                        <div class="form-group">
                      <div class="col-md-10">
                        ...
                        <div class="col-md-8">
                          <input name="caddress" type="text" value="<?php echo $res->company_address; ?>" class="form-control input-sm" id="caddress" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-10">
                        ...
                        <div class="col-md-8">
                          <input name="zip" type="text" value="<?php echo $res->zip_code; ?>" class="form-control input-sm" id="zip" />
                        </div>
                      </div>
                    </div> 
